...
CATEGORIES = [
	...
	{"id": "time", "title": "Time, Leave, and Payroll", "tone": "Payroll"},
...
FEATURES = [
	{"id": "attendance-action-hub", "category": "daily", "title": "Attendance Action Hub", "summary": "Daily attendance command page for exceptions, follow-up, and action routing.", "target_type": "Page", "target": "attendance-action-hub", "priority": "Primary"},
	{"id": "team-attendance-review", "category": "daily", "title": "Team Attendance Review", "summary": "Team-level report for attendance control and manager follow-up.", "target_type": "Report", "target": "Team Attendance Review", "priority": "Primary"},
	...
	{"id": "saudi-hr-settings", "category": "setup", "title": "Hr Suite Settings", "summary": "Central control for Hr Suite policies, voice mode, rates, alerts, and operating preferences.", "target_type": "DocType", "target": "Hr Suite Settings", "priority": "Primary", "allow_entry": False, "action_label": "Open Settings"},
	{"id": "attendance-location", "category": "setup", "title": "Attendance Location", "summary": "Define approved attendance zones and geofencing rules for mobile check-ins.", "target_type": "DocType", "target": "Attendance Location", "priority": "Primary"},
	...
	{"id": "saudi-regulatory-task", "category": "setup", "title": "Saudi Regulatory Task", "summary": "Track statutory HR tasks, due dates, owners, and closure evidence.", "target_type": "DocType", "target": "Saudi Regulatory Task"},
	...
	{"id": "saudi-monthly-payroll", "category": "time", "title": "Saudi Monthly Payroll", "summary": "Run monthly Saudi payroll with deductions, contributions, and settlement context.", "target_type": "DocType", "target": "Saudi Monthly Payroll", "priority": "Primary"},
	...
	{"id": "saudi-employee-checkin", "category": "time", "title": "Saudi Employee Checkin", "summary": "Review employee check-in and check-out movements.", "target_type": "DocType", "target": "Saudi Employee Checkin"},
	{"id": "saudi-daily-attendance", "category": "time", "title": "Saudi Daily Attendance", "summary": "Daily attendance records for operational payroll and compliance follow-up.", "target_type": "DocType", "target": "Saudi Daily Attendance"},
	{"id": "monthly-attendance-record", "category": "time", "title": "Monthly Attendance Record", "summary": "Monthly attendance consolidation for payroll review.", "target_type": "DocType", "target": "Monthly Attendance Record"},
	{"id": "saudi-employee-voice-profile", "category": "time", "title": "Saudi Employee Voice Profile", "summary": "Manage employee voice profiles when full biometric mode is enabled.", "target_type": "DocType", "target": "Saudi Employee Voice Profile"},
	{"id": "saudi-shift-type", "category": "time", "title": "Saudi Shift Type", "summary": "Define Hr Suite shift schedules used by attendance and payroll controls.", "target_type": "DocType", "target": "Saudi Shift Type"},
	{"id": "saudi-shift-assignment", "category": "time", "title": "Saudi Shift Assignment", "summary": "Assign employees to Hr Suite shift schedules for attendance validation.", "target_type": "DocType", "target": "Saudi Shift Assignment"},
	{"id": "saudi-shift-assignment-tool", "category": "time", "title": "Saudi Shift Assignment Tool", "summary": "Bulk assign Hr Suite shifts inside the Hr Suite app.", "target_type": "DocType", "target": "Saudi Shift Assignment Tool"},
	...
	{"id": "saudi-annual-leave", "category": "time", "title": "Saudi Annual Leave", "summary": "Manage annual leave requests, balances, approvals, and disbursement context.", "target_type": "DocType", "target": "Saudi Annual Leave", "priority": "Primary"},
	{"id": "saudi-sick-leave", "category": "time", "title": "Saudi Sick Leave", "summary": "Track sick leave rules, thresholds, and approval workflow.", "target_type": "DocType", "target": "Saudi Sick Leave"},
	...
	{"id": "monthly-attendance-detail", "category": "components", "title": "Monthly Attendance Detail", "summary": "Employee-level attendance detail line used in monthly attendance consolidation.", "target_type": "DocType", "target": "Monthly Attendance Detail", "allow_entry": False, "route_target_type": "DocType", "route_target": "Monthly Attendance Record", "action_label": "Open Parent Records"},
	{"id": "payroll-adjustment-item", "category": "components", "title": "Payroll Adjustment Item", "summary": "Payroll adjustment line component used inside monthly payroll processing.", "target_type": "DocType", "target": "Payroll Adjustment Item", "allow_entry": False, "route_target_type": "DocType", "route_target": "Saudi Monthly Payroll", "action_label": "Open Parent Records"},
	{"id": "saudi-monthly-payroll-employee", "category": "components", "title": "Saudi Monthly Payroll Employee", "summary": "Employee payroll line component generated within Saudi monthly payroll runs.", "target_type": "DocType", "target": "Saudi Monthly Payroll Employee", "allow_entry": False, "route_target_type": "DocType", "route_target": "Saudi Monthly Payroll", "action_label": "Open Parent Records"},
