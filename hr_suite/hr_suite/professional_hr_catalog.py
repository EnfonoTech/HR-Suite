...
FEATURES = [
	...
	{"id": "appraisal", "category": "performance", "title": "Appraisal", "summary": "Manage employee performance reviews and development outcomes.", "target_type": "DocType", "target": "Appraisal", "priority": "Primary"},
