...
COMPLIANCE_DOCTYPES = [
	...
	make_doctype(
		...
		[
			...
			field("status", "Select", "Status", options="Compliant", default="Needs Review", in_list_view=1),
	...
	[
		...
		make_doctype(
			...
			[
				...
				field("priority", "Select", "Priority", options="Mandatory Review", default="Recommended"),
		...
		make_child_doctype(
			...
			[
				...
				column("column_break_1"),
				field("severity", "Select", "Severity", options="Low", default="Medium"),
				field("status", "Select", "Status", options="Open", default="Open", in_list_view=1),
		...
		make_doctype(
			...
			[
				...
				field("company", "Link", "Company", options="Company", fetch_from="employee.company", in_list_view=1),
				field("category", "Select", "Category", reqd=1, in_list_view=1, options="\nYoung Worker"),
				field("status", "Select", "Status", in_list_view=1, options="Draft", default="Needs Review"),
		...
		make_doctype(
			...
			[
				...
				field("required_action", "Select", "Required Action", options="Extend Leave", default="Legal Review", in_list_view=1),
				field("status", "Select", "Status", options="Open", default="Open", in_list_view=1),
				column("column_break_2"),
