    ...
    employee(frm) {
        ...
        frappe.call({
            ...
            callback(r) {
                ...
                frappe.call({
                    method: 'hr_suite.hr_suite.doctype.sick_leave.sick_leave.get_sick_days_this_year',
                ...
                // Fetch daily salary
                frappe.call({
                    method: 'hr_suite.hr_suite.doctype.sick_leave.sick_leave.get_daily_salary',
